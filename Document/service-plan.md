...
Initial implementation: board cards can open a task detail drawer showing editable metadata, dependencies, branch/worktree, merge state, task-scoped comments, task-scoped runs, changed files, run output/errors, handoff history, and an activity timeline.
